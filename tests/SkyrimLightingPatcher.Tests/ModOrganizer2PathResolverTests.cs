...
public sealed class ModOrganizer2PathResolverTests
{
    ...
    public async Task TryResolveSkyrimSeAsync_ReturnsMatchingGlobalInstance()
    {
        ...
        Assert.Equal(SkyrimLightingPatcher.Core.Models.ModOrganizer2InstanceKind.Global, result.InstanceKind);
    }
    ...
    public async Task TryResolveSkyrimSeAsync_ResolvesPortableCandidateFromProfilePath()
    {
        ...
        Assert.Equal(SkyrimLightingPatcher.Core.Models.ModOrganizer2InstanceKind.Portable, result.InstanceKind);
    }
    ...
    public async Task TryResolveSkyrimSeAsync_PrefersPortableWhenRequested()
    {
        ...
        var result = await resolver.TryResolveSkyrimSeAsync(SkyrimLightingPatcher.Core.Models.ModOrganizer2InstanceKind.Portable);
    ...
    public async Task TryResolveSkyrimSeAsync_DoesNotUsePortableDiscovery_WhenGlobalRequested()
    {
        ...
        var result = await resolver.TryResolveSkyrimSeAsync(SkyrimLightingPatcher.Core.Models.ModOrganizer2InstanceKind.Global);
